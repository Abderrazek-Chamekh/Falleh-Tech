...
public class OffreController {
    ...
    private void toggleTableVisibility() {
        boolean currentlyVisible = offreTable.isVisible();
        offreTable.setVisible(!currentlyVisible);
        offreTable.setManaged(!currentlyVisible); // ensures layout resizes properly
    }
