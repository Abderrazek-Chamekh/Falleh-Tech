...
public class ProduitService {
    ...
    public List<Produit> getAll() {
        ...
        String sql = """
        SELECT p.*, c.id AS cat_id, c.nom AS cat_nom, sc.id AS sc_id, sc.nom AS sc_nom
        FROM produit p
    ...
    """;
        ...
        try (PreparedStatement ps = cnx.prepareStatement(sql)) {
            ...
            try (ResultSet rs = ps.executeQuery()) {
                while (rs.next()) {
                    Produit p = mapProduit(rs);

                    // Charger aussi l'utilisateur du produit
                    User user = new User();
    ...
    public List<Produit> getProduitsDesAutres(int userId) {
        List<Produit> produits = new ArrayList<>();
        String sql = """
